      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-8">
            I'm currently looking for Data Science and ML opportunities. Whether you have a question
            about my projects, want to collaborate, or just want to say hi — feel free to reach out!
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-700 transition-colors shadow-sm"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
